...
const value= (marksObtained/maximumMarks)*100;
  return (
    <div className="my-8 mx-3 max-[500px]:ml-0 flex flex-col justify-center w-[25rem] rounded-[15px] overflow-hidden shadow-lg  bg-[#F2F6FF] border border-[#C4C4C4]">
        <div className='flex ml-4 mt-3'>
        <img src={Examlogo} className='w-1/6' alt="" />
      <div className='flex flex-col mt-1 '>
        <span className='text-[#004BB8] font-medium text-lg ml-2 mt-3 w-[9rem]'>{subject}</span>
      ...
      <LinearProgress variant="determinate" value={value} sx={{height: 10, borderRadius:5, backgroundColor:'#FFFFFF', '& .MuiLinearProgress-bar': {backgroundColor: '#004BB8', borderRadius:5},}} className='mb-5 w-[22rem] ml-5 mt-1'/>
