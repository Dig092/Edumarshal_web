            ...
            <div className="flex flex-col items-center">
              <div className="flex my-3 justify-center shadow-md rounded-2xl bg-white">
                <div className="flex flex-col">
                  ...
                  <h1 className="px-6 pb-4">Attendance - 39/57</h1>
                </div>
          ...
          <div className="w-[70%] flex flex-col items-start h-full rounded-2xl">
            <div className="flex justify-center items-center px-8 py-2 gap-11">
              ...
              <div className="flex items-center justify-center w-[65px] h-[49px] bg-[#F2F6FF] rounded-lg">
                <h1 className="font-semibold text-[#004BB8]">1</h1>
              </div>
              <div className="flex items-center justify-center w-[65px] h-[49px] bg-[#F2F6FF] rounded-lg">
                <h1 className="font-semibold text-[#004BB8]">2</h1>
              </div>
              <div className="flex items-center justify-center w-[65px] h-[49px] bg-[#F2F6FF] rounded-lg">
                <h1 className="font-semibold text-[#004BB8]">3</h1>
              </div>
              <div className="flex items-center justify-center w-[65px] h-[49px] bg-[#F2F6FF] rounded-lg">
                <h1 className="font-semibold text-[#004BB8]">4</h1>
              </div>
              <div className="flex items-center justify-center w-[65px] h-[49px] bg-[#F2F6FF] rounded-lg">
                <h1 className="font-semibold text-[#004BB8]">5</h1>
              </div>
              <div className="flex items-center justify-center w-[65px] h-[49px] bg-[#F2F6FF] rounded-lg">
                <h1 className="font-semibold text-[#004BB8]">6</h1>
              </div>
              <div className="flex items-center justify-center w-[65px] h-[49px] bg-[#F2F6FF] rounded-lg">
                <h1 className="font-semibold text-[#004BB8]">7</h1>
              </div>
            </div>
...
export default Attendance;
>>>>>>> 7bbcda4ee61b1ddc1c267f9f274ca17eb139e555
