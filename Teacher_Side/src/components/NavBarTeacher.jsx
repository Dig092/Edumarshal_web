...
export default function NavBarTeacher(props) {
    return (
        <div className='bg-white px-10 py-8 w-full mx-auto h-[60px] flex justify-between items-center'>
            <h1 className='text-2xl text-black font-semibold'>{props.title}</h1>
